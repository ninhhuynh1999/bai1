    ...
    <form method="POST" action="{{ route('shippingUnit.update') }}">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    <label>Địa chỉ</label>
                    <textarea name="address" class="form-control" rows="3" value="{{ $model->address }}" placeholder="Nhập địa chỉ"></textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label>Thông tin liên hệ</label>
                    <textarea name="contact" class="form-control" rows="3" value="{{ $model->contact }}" placeholder="Nhập thông tin liên hệ"></textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label>Ghi chú</label>
                    <textarea name="note" class="form-control" rows="3" value="{{ $model->note }}" placeholder="Nhập ghi chú"></textarea>
                </div>
            </div>
        </div>
        <div class="row">
